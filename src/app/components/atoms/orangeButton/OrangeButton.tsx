...
export default function OrangeButton({ text }: OrangeButtonInterface) {
  return (
    <button className="relative cursor-pointer bg-[#CB684D] text-white font-medium py-4 px-8 rounded-[16px] overflow-hidden transition-transform duration-300  group">
