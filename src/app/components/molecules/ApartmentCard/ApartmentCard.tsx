...
const ApartmentCard: React.FC<ApartmentCardProps> = ({
  ...
  return (
    <div
      className="bg-[#FFFFFF] rounded-[32px] overflow-hidden w-full max-w-[295px] h-[468px] flex flex-col mx-auto cursor-pointer" // Add cursor-pointer for feedback
    ...
    >
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="mt-auto">
          ...
          <div
            className="inline-block bg-[#F0F0F0] text-[#1C1C1E] text-[12px] md:text-[14px] py-[12.5px] px-[14px] rounded-full capitalize"
            onClick={onClick}
          >
            {t("ViewDetails")}
          </div>
